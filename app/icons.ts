export const ICONS = {
  ...
  // Bridge icon (LI.FI integration)
  bridge: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M2 18h20M5 18V8a3 3 0 0 1 3-3h8a3 3 0 0 1 3 3v10"/><path d="M9 18v-4h6v4"/><circle cx="7" cy="12" r="1" fill="currentColor"/><circle cx="17" cy="12" r="1" fill="currentColor"/></svg>`,
  // Arrow icons
