...
\begin{tikzpicture}[scale=0.85]
    ...
    \node[realbox, minimum width=2cm] (lifi) at (-5.5, 2) {LI.FI\\Bridge};
    \node[realbox, minimum width=2cm] (valantis) at (-2.75, 2) {Valantis\\stHYPE};
    \node[realbox, minimum width=2cm] (pear) at (0, 2) {Pear\\Execution};
    \node[saltbox, minimum width=2cm] (salt) at (2.75, 2) {Salt\\Orchestration};
...
\subsection{Track 2: Valantis --- Yield Generation}
...
\subsection{Track 3: Pear Protocol --- Trade Execution}
...
\begin{itemize}[leftmargin=*]
    \item REST API integration for position management
    \item Open long/short positions on supported pairs
    \item Position monitoring and P\&L tracking
    \item Prospective: automated hedging for protocol exposure
\end{itemize}

\subsection{Track 4: Salt --- Automated Strategy Execution}
...
\begin{itemize}[leftmargin=*]
    \item Real LI.FI integration for cross-chain onboarding
    \item Real Valantis integration for protocol treasury yield
    \item Real Pear integration for trade execution
    \item Real Salt integration for Robo Manager automated execution
